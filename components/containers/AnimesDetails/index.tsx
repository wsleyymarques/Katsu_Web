...
import {BookmarkPlus, Calendar, ChevronLeft, Clock, Film, Heart, Play, Share2, Star, Users} from "lucide-react";
...
export default async function AnimeDetails({ id }: AnimeDetailsProps) {
